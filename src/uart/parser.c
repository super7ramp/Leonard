...
t_beacon_info beaconTab[NUMBER_BEACONS]={ 
	...
	{{{0x00, 0x07, 0x80, 0xad, 0x09, 0x4b}, {0, 5}},0,0}, //B
	{{{0x00, 0x07, 0x80, 0xad, 0x09, 0x4f}, {0, 10}},0,0}, //C
	{{{0x00, 0x07, 0x80, 0xad, 0x09, 0x4e}, {8, 10}},0,0}, //D
	{{{0x00, 0x07, 0x80, 0xad, 0x09, 0x4a}, {8, 5}},0,0}, //E
	{{{0x00, 0x07, 0x80, 0xad, 0x09, 0x55}, {8, 0}},0,0},  //F
	{{{0x00, 0x07, 0x80, 0xad, 0x09, 0x95}, {4, 2.5}}, 0, 0}, //G
	{{{0x00, 0x07, 0x80, 0xad, 0x09, 0x33}, {4, 7.5}}, 0, 0}
	};
