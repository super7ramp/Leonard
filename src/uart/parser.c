...
t_beacon_info beaconTab[NUMBER_BEACONS]={ 
	{{{0x00, 0x07, 0x80, 0xad, 0x09, 0x46}, {0, 0}, {2, 2}},0,0}, //A
	{{{0x00, 0x07, 0x80, 0xad, 0x09, 0x4b}, {0, 5}, {2, 5}},0,0}, //B
	{{{0x00, 0x07, 0x80, 0xad, 0x09, 0x4f}, {0, 10}, {2, 8}},0,0}, //C
	{{{0x00, 0x07, 0x80, 0xad, 0x09, 0x4e}, {8, 10}, {6, 8}},0,0}, //D
	{{{0x00, 0x07, 0x80, 0xad, 0x09, 0x4a}, {8, 5}, {6, 5}},0,0}, //E
	{{{0x00, 0x07, 0x80, 0xad, 0x09, 0x55}, {8, 0}, {6, 2}},0,0}  //F
	};
